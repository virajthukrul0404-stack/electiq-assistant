/**
 * @file eligibility.js
 * @description Eligibility checker component
 */
(function () {
   ...
   */
  namespace.components.renderEligibility = function (container) {
    if (!container) return;
    container.innerHTML = `
    ...
    // The event listeners and actual logic are bound in app.js via setupEligibilityChecker()
  };
})();
